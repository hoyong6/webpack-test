...
with (obj) {
__p += '<div class="layer">\n    <div>this my text webpack</div>\n    <img src="' +
((__t = ((__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/image/slice1.png\""); e.code = 'MODULE_NOT_FOUND';; throw e; }()))))) == null ? '' : __t) +
'" alt="">\n    <div> this is ' +
((__t = ( name )) == null ? '' : __t) +
' layer </div>\n    ';
...
module.exports = __webpack_require__.p + "402adb1272dd5cd2aca454fa08ecb406.png";
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/lib/loader.js!./layer.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/lib/loader.js!./layer.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
